        ...
        <div className="space-y-4">
            {!type ? (
                ...
                <form
                    ...
                    className="p-4 rounded-md border border-[var(--color-border-default)] bg-[var(--color-bg-secondary)] space-y-3"
                >
                    <div className="flex justify-between items-center mb-2">
                        <Label className="text-[9px] font-black uppercase tracking-[0.1em] text-[var(--color-accent-hover)]">
                            Registrar {type === 'INCOME' ? 'Entrada' : 'Salida'}
                        </Label>
                        <button
                            type="button"
                            onClick={() => setType(null)}
                            className="text-[9px] font-bold text-[var(--color-text-tertiary)] hover:text-[var(--color-text-primary)] uppercase transition-colors"
                        >
                            Cancelar
                        </button>
                    </div>
                    ...
                    <Button
                        ...
                        disabled={isPending}
                        variant="accent"
                        className="w-full rounded-md text-[10px] font-black uppercase tracking-widest gap-2"
                    >
