...
export default function LayoutImageCenter({ banner }: { banner: SliderBanner }) {
    ...
    return (
        <Link
            ...
            /* Contenedor raíz: Ocupa todo el ancho de pantalla para el fondo */
            className="banner-slot group relative w-full overflow-hidden h-[var(--banner-h-mobile)] md:h-[var(--banner-h)] flex flex-col"
        ...
        >
            ...
            {/* ── Capa de Contenido: Limitada a max-w-6xl ── */}
            <div className="relative z-20 w-full max-w-6xl mx-auto h-full px-6 flex flex-col items-center justify-end text-center pb-12 sm:pb-16 md:justify-center md:pb-0">
                ...
                >
                    {subtitle && (
                        <div className="mb-2" style={fadeUp(0.1)}>
                            <span
                                className="inline-block text-[10px] sm:text-[12px] font-black uppercase px-2 py-1"
                                style={{
                    ...
                    {title && (
                        <h2
                            className="font-black leading-[1] tracking-[-0.05em] text-[clamp(2rem,6vw,4.5rem)] mb-0"
                            style={fadeUp(0.2, {
                                transform: loaded
                    ...
                    {description && (
                        <p
                            className="mt-2 md:mt-4 text-[13px] sm:text-[15px] md:text-[17px] leading-relaxed max-w-[38ch] line-clamp-2 font-medium"
                            style={{
                                color: muted,
                                ...fadeUp(0.35),
