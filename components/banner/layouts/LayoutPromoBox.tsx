...
export default function LayoutPromoBox({ banner }: { banner: SliderBanner }) {
    ...
    return (
        <Link
            ...
            /* Contenedor raíz: Fondo a ancho completo */
            className="banner-slot group relative flex items-center justify-center w-full overflow-hidden h-[var(--banner-h-mobile)] md:h-[var(--banner-h)]"
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto h-full px-6 sm:px-10 flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 sm:gap-8 md:gap-12 py-6 md:py-0">

                {/* ── INFO BLOCK (CARD) ── */}
                <div
                    className="
                        relative flex-shrink-0 
                        w-full max-w-[300px] sm:max-w-[340px] md:max-w-[380px] lg:max-w-[400px] 
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3 sm:gap-5 md:gap-6 text-center md:text-left">
                            ...
                            {title && (
                                <h2 className="text-[clamp(1.2rem,3vw,2.2rem)] font-bold leading-[1.1] tracking-tight" style={{ color: text }}>
                                    {title}
                                </h2>
                            )}
