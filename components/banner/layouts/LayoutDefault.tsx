...
export default function LayoutDefault({ banner }: { banner: SliderBanner }) {
    ...
    const bg = design.bgColor ?? (isDark ? "#080808" : "#ffffff");
                ...
                >
                    ...
                    {description && (
                        <div style={fadeUp(0.3)} className="relative">
                            <p
                                className="text-[11px] sm:text-[13px] md:text-[15px] leading-relaxed line-clamp-3 sm:line-clamp-4 max-w-[32ch]"
                                style={{ color: muted }}
                            >
                                {description}
                            </p>
                ...
                >
                    ...
                    {title && (
                        <div className="flex flex-col items-center gap-2 mt-2 sm:mt-5 max-w-full">
                            <h2
                                className="flex-none font-semibold leading-[1.1] tracking-[-0.03em] text-[clamp(1.2rem,2.2vw,2.5rem)] text-center line-clamp-2"
                                style={{ color: text }}
                            >
                                {title}
                            </h2>
