...
export default function LayoutImageLeft({ banner }: { banner: SliderBanner }) {
    ...
    return (
        <Link
            ...
            /* Contenedor raíz con fondo a ancho completo */
        ...
        >
            {/* 
                ...
                Mantenemos la estructura de grid para el diseño "Image Left".
            */}
            <div className="max-w-6xl mx-auto h-full flex flex-col md:grid md:grid-cols-[58fr_42fr] md:items-stretch">
                ...
                >
                    ...
                    {title && (
                        <h2
                            className="font-bold leading-[1.1] tracking-[-0.03em] text-[clamp(1.5rem,4vw,3rem)] mb-4 md:mb-5 max-w-[15ch]"
                            style={fadeUp(0.13)}
                        >
                            {title}
                        </h2>
