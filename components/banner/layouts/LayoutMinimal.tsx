    ...
    return (
        <Link
            ...
            /* 
                ...
                Mantenemos h-full o la altura variable del banner.
            */
            className="banner-slot group relative overflow-hidden flex items-center w-full h-[var(--banner-h-mobile)] md:h-[var(--banner-h)]"
            style={{ backgroundColor: colors.bg }}
        >
            {/* ── Capa de Contenido: Restringida a max-w-6xl ── */}
            <div className="relative z-10 w-full max-w-6xl mx-auto h-full flex flex-col lg:flex-row items-center px-6">
                
                {/* ── Columna Texto (Orden 1 en LG para que aparezca a la izquierda) ── */}
                <div
                    className="
                        relative z-10
                        order-2 lg:order-1
                ...
                >
                    ...
                    {title && (
                        <h2
                            className="w-full text-[clamp(1.5rem,4vw,3rem)] font-bold leading-[1.05] tracking-[-0.04em] mb-4 md:mb-6"
