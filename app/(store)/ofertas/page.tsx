...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
    ...
    return {
        title: "Ofertas y Liquidación | S&C Mobile",
        description: "Aprovecha descuentos exclusivos en celulares, audio y accesorios. Precios rebajados por tiempo limitado en S&C Mobile Perú.",
        alternates: {
            canonical: `${process.env.NEXT_PUBLIC_BASE_URL}/ofertas`,
        },
        openGraph: {
            title: "Ofertas Exclusivas | S&C Mobile",
