...
export default function ContactoSoportePage() {
    const methods = [
        { title: "Canal Digital", val: "+51 972 416 683", href: "https://wa.me/51972416683", icon: FaWhatsapp, color: "text-green-600 dark:text-green-400" },
        { title: "Buzón Oficial", val: "sycmobilecanete@gmail.com", href: "mailto:sycmobilecanete@gmail.com", icon: Mail, color: "text-primary" },
        { title: "Sede Central", val: "Av. Mariscal Benavides 713", desc: "San Vicente de Cañete, Perú", icon: MapPin, color: "text-destructive" },
        { title: "Horario de atencion", val: "Lun–Sáb 10am – 9pm", desc: "Horario de atención presencial", icon: Clock, color: "text-muted-foreground" }
    ];
